...
<body>
    ...
    <main class="container product-page">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/public_html/homepage.php">Home</a></li>
                <li class="breadcrumb-item"><a href="/public_html/products.php">Products</a></li>
                <li class="breadcrumb-item"><a href="/public_html/products.php?category=<?php echo urlencode($product['category']); ?>"><?php echo e($product['category']); ?></a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                ...
                if (strpos($imagePath, 'http') !== 0 && strpos($imagePath, '/') !== 0) {
                    $imagePath = '/public_html/' . $imagePath;
                }
                ?>
                ...
                <?php if ($canDelete): ?>
                    <div class="mt-3">
                        <a href="/public_html/delete_product.php?id=<?php echo $product['id']; ?>" 
            ...
            <div class="col-lg-6">
                <div class="product-info">
                    ...
                    <div class="add-to-cart-section">
                        <?php if (isLoggedIn()): ?>
                            <form action="/public_html/cart_add.php" method="POST" class="d-flex align-items-center gap-3 flex-wrap">
                                <input type="hidden" name="product_id" value="<?php echo $product['id']; ?>">
                                
                                <div class="d-flex align-items-center gap-2">
                                    <label for="qty" class="mb-0">Qty:</label>
                                    <input type="number" name="qty" id="qty" value="1" min="1" max="99" class="form-control qty-input">
                                </div>
                        ...
                        <?php else: ?>
                            ...
                            <a href="/public_html/login.php" class="btn-add-cart text-decoration-none d-inline-block">Login to Shop</a>
                        <?php endif; ?>
                    </div>
        ...
        <section class="mt-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <?php if (isLoggedIn()): ?>
                    <a href="/public_html/add_review.php?product_id=<?php echo $product['id']; ?>" class="btn btn-outline-primary">
                        ✍️ Write a Review
                    </a>
                <?php endif; ?>
            </div>
            ...
            <div class="similar-grid">
                <?php foreach ($similarProducts as $similar): ?>
                    ...
                    if (strpos($simImage, 'http') !== 0 && strpos($simImage, '/') !== 0) {
                        $simImage = '/public_html/' . $simImage;
                    }
                    ?>
                    <a href="/public_html/product.php?id=<?php echo $similar['id']; ?>" class="similar-card text-decoration-none">
