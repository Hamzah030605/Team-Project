...
if ($existingReview) {
    ...
    header('Location: /public_html/product.php?id=' . $productId);
    exit;
}
        ...
        <?php if ($success): ?>
            <div class="review-card">
                <div class="success-message">
                    ...
                    <?php if (!empty($remainingProducts)): ?>
                        <div class="more-products">
                            ...
                            <?php foreach ($remainingProducts as $p): ?>
                                <a href="/public_html/add_review.php?product_id=<?php echo $p['id']; ?>&from=checkout" class="product-to-review">
                                    <img src="/public_html/<?php echo e($p['image'] ?? 'assets/images/products/default.svg'); ?>" alt="">
                                    <div>
                    ...
                    <?php else: ?>
                        <div class="mt-4">
                            <a href="/public_html/products.php" class="btn btn-primary">Continue Shopping</a>
                            <a href="/public_html/product.php?id=<?php echo $productId; ?>" class="btn btn-outline-secondary">View Product</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="review-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="text-center mt-3">
                            <a href="/public_html/product.php?id=<?php echo $productId; ?>" class="text-muted">Skip for now</a>
                        </div>
                    </form>
