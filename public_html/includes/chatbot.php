...
(function() {
    const chatbotResponses = {
        ...
        order: {
            ...
            responses: [
                "I can help you with your order! 📦\n\nTo check your order status:\n1. Click on your profile icon\n2. Select 'My Orders'\n3. View all your past and current orders\n\nOr go directly to: <a href='/public_html/orders.php'>My Orders</a>",
                "For order tracking, please visit your <a href='/public_html/orders.php'>Order History</a>. You'll find all delivery updates there!"
            ]
        },
        ...
        returns: {
            ...
            responses: [
                "↩️ <b>Our Return Policy:</b>\n\n• 30-day free returns\n• Products must be unused and sealed\n• Refunds processed within 5-7 days\n\nTo start a return, please email us at support@serenique.com or use our <a href='/public_html/contact.php'>Contact Form</a>."
            ]
        },
        ...
        account: {
            ...
            responses: [
                "For account help:\n\n• <a href='/public_html/login.php'>Login</a> to your account\n• <a href='/public_html/register.php'>Create new account</a>\n• Forgot password? Use the reset link on login page\n\nNeed more help? Contact our support team!"
            ]
        },
        ...
        contact: {
            ...
            responses: [
                "📞 <b>Contact Us:</b>\n\n• Email: support@serenique.com\n• Phone: +44 123 456 7890\n• Hours: Mon-Fri 9am-6pm\n\nOr use our <a href='/public_html/contact.php'>Contact Form</a> and we'll get back to you within 24 hours!"
            ]
        },
        ...
        default: [
            ...
            "Hmm, I didn't quite catch that. Would you like to:\n\n• <a href='/public_html/products.php'>Browse products</a>\n• <a href='/public_html/orders.php'>Check orders</a>\n• <a href='/public_html/contact.php'>Contact support</a>"
        ]
    };
